...
public final class PillDispenserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<DownloadReq,
      MedPlan> getDownloadMedPlanMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "downloadMedPlan",
      requestType = DownloadReq.class,
      responseType = MedPlan.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<DownloadReq,
      MedPlan> getDownloadMedPlanMethod() {
    io.grpc.MethodDescriptor<DownloadReq, MedPlan> getDownloadMedPlanMethod;
      ...
      synchronized (PillDispenserServiceGrpc.class) {
        if ((getDownloadMedPlanMethod = PillDispenserServiceGrpc.getDownloadMedPlanMethod) == null) {
          PillDispenserServiceGrpc.getDownloadMedPlanMethod = getDownloadMedPlanMethod = 
              io.grpc.MethodDescriptor.<DownloadReq, MedPlan>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "assign3.grpc.PillDispenserService", "downloadMedPlan"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  DownloadReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  MedPlan.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<TakenMedication,
      EmptyMessage> getSendMedicationStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMedicationStatus",
      requestType = TakenMedication.class,
      responseType = EmptyMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<TakenMedication,
      EmptyMessage> getSendMedicationStatusMethod() {
    io.grpc.MethodDescriptor<TakenMedication, EmptyMessage> getSendMedicationStatusMethod;
      ...
      synchronized (PillDispenserServiceGrpc.class) {
        if ((getSendMedicationStatusMethod = PillDispenserServiceGrpc.getSendMedicationStatusMethod) == null) {
          PillDispenserServiceGrpc.getSendMedicationStatusMethod = getSendMedicationStatusMethod = 
              io.grpc.MethodDescriptor.<TakenMedication, EmptyMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "assign3.grpc.PillDispenserService", "sendMedicationStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TakenMedication.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class PillDispenserServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void downloadMedPlan(DownloadReq request,
                                io.grpc.stub.StreamObserver<MedPlan> responseObserver) {
      asyncUnimplementedUnaryCall(getDownloadMedPlanMethod(), responseObserver);
    }

    /**
     */
    public void sendMedicationStatus(TakenMedication request,
  ...
  public static final class PillDispenserServiceBlockingStub extends io.grpc.stub.AbstractStub<PillDispenserServiceBlockingStub> {
    ...
    /**
     */
    public MedPlan downloadMedPlan(DownloadReq request) {
    ...
    /**
     */
    public EmptyMessage sendMedicationStatus(TakenMedication request) {
      return blockingUnaryCall(
  ...
  public static final class PillDispenserServiceFutureStub extends io.grpc.stub.AbstractStub<PillDispenserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<MedPlan> downloadMedPlan(
        DownloadReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<EmptyMessage> sendMedicationStatus(
        TakenMedication request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DOWNLOAD_MED_PLAN:
          serviceImpl.downloadMedPlan((DownloadReq) request,
              (io.grpc.stub.StreamObserver<MedPlan>) responseObserver);
          break;
        case METHODID_SEND_MEDICATION_STATUS:
          serviceImpl.sendMedicationStatus((TakenMedication) request,
              (io.grpc.stub.StreamObserver<EmptyMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class PillDispenserServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return PillDispenser.getDescriptor();
    }
